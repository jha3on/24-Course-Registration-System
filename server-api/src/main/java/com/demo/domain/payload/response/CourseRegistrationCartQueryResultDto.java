...
public class CourseRegistrationCartQueryResultDto implements Serializable {
    ...
    public CourseRegistrationCartQueryResultDto(Long courseId, String courseType, String courseNumber, String courseTimetable, Integer courseCredit, Integer courseRegistrationCount, Integer courseRegistrationCountCart, Integer courseRegistrationCountLimit, String collegeName, String collegeDivisionName, String collegeDepartmentName, String collegeCourseName) {
    ...
    @QueryProjection
    @Builder(access = AccessLevel.PUBLIC)
    public CourseRegistrationCartQueryResultDto(Course course, College college, CollegeDivision collegeDivision, CollegeDepartment collegeDepartment, CollegeCourse collegeCourse) {
